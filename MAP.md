...
> このリポジトリ（Mame-AI-Agent）の単一索引。各領域の役割・入口をここで一元管理する。
...
- **README.md** → scripts/install.sh、AGENTS.md、MAP.md
- **scripts/install.sh** → skills/<name>/SKILL.md → .claude/skills/ または .github/skills/
